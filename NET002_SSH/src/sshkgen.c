/*
 * sshkgen — SSH key generator for FujiNet
 *
 * Sends N:SSH.KEYGEN://ed25519/ to FujiNet, reads the result,
 * prints it, and exits.
 *
 * Build:  cl65 -t atari -o build/sshkgen.com src/sshkgen.c
 *
...
/* Buffers                                                            */
/* ------------------------------------------------------------------ */
static unsigned char devicespec[] = "N:SSH.KEYGEN://ed25519/\x9b";
